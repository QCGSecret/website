...
Some numbers will appear as pink instead of white these are good numbers that need to have a coin on them at the first
table.
<br /> 4 numbers will be good. The coin on 32 need to stay all time on the second table. <br />
...
<Gallery>
	<Image src="/assets/guide/casino/hackinggame/vent.png" width="333" height="238" alt="The vent." loading="lazy" />
	<Image src="/assets/guide/casino/hackinggame/phone.png" width="333" height="238" alt="The phone." loading="lazy" />
</Gallery>
...
<Image src="/assets/guide/casino/chosen/atm.png" width="721" height="721" alt="The atm machine." loading="lazy" />

Once the correct PIN is entered, wait 40 seconds for the money to be dispensed. Afterward, collect the money and place it in the coin exchanger to receive two yellow coins and one green coin.

<Image
	src="/assets/guide/casino/chosen/transform.png"
	width="721"
	height="721"
	alt="The coin exchanger."
	loading="lazy"
/>

One person must collect the green coin and use it on a gambling machine. After a short animation showing a win, the player will receive a lucky message. Following this, interact with the fate machine; unlike before, rather than perishing, you will receive an electric shock and be granted the Chosen Title. Go outside and approach the arcade machine to shock and activate it.
