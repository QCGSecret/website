...
After activating the machine, you'll need to insert 8 coins. Following that, you'll be prompted to donate blood; 8 people must interact with the blade on the machine and press the green buttons to initiate the game. Be cautious, as interacting with it will set your HP to 1.
